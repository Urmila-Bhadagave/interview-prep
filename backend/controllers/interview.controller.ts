...
export const createInterview = catchAsyncErrors(async (body: InterviewBody) => {
  ...
  // ✅ Limit the number of questions to 40 maximum
  if (numOfQuestions > 30) {
    throw new Error("Number of questions cannot exceed 40");
  }

  // (Optional) ✅ Ensure at least 1 question
  if (numOfQuestions <= 1) {
    throw new Error("Number of questions must be at least 2");
  }
